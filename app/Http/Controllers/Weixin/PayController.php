    ...
    //通知回调
     ...
     public function test(){
         ...
         $orderInfo=[
             ...
             'notify'=>$this->weixin_notify_url,
             'trade_type'=>'NATIVE'
         ];

         $this->values=[];
         $this->values=$orderInfo;
         $this->SetSign();
         $xml=$this->ToXml();
         $rs=$this->$this->postXmlCurl($xml,$this->weixin_unfiedorder_url,$useCert=false,$second=30);
         $data=simplexml_load_strig($rs);
